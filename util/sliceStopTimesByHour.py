...
stop_times_path = "../raw_data/stop_times.txt"
...
early_morning_data.to_csv('../resources/stop_times/stop_times_00h.csv', index=False)
...
for hour in range(5, 24):
    ...
    # 파일로 저장
    output_filename = f'../resources/stop_times/stop_times_{hour:02d}h.csv'
