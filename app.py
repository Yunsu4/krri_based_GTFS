...
def process_and_print_sorted_trips(processed_trips, sort_type, print_count, stop_times, stops, routes):
    # 정렬 함수 매핑
    sort_functions = {
    ...
    view.outputView.print_trip_info(final_sorted_trips, sort_type, print_count, journey_stops, routes)
...
def main():
    ...
    if not departure_stops.empty:
        ...
        #'pickup_type', 'drop_off_type','stop_name'] 가짐
        # stop_times의 모든 열, stop_name을 가짐
        ...
        #process_and_print_sorted_trips(processed_trips, "default", 8, stop_times, stops, routes)
        process_and_print_sorted_trips(processed_trips, "total_journey_time", 5, stop_times, stops, routes)
        #process_and_print_sorted_trips(processed_trips, "taxi_distance", 5, stop_times, stops, routes)
        #process_and_print_sorted_trips(processed_trips, "walking_distance", 5, stop_times, stops, routes)   
